    ...
    public class SimulatedObjectStorageService : SimulatedService
    {
        ...
        protected override async Task<HttpResponseMessage> ProcessRequestImplAsync(HttpListenerContext context, Uri dispatchUri, CancellationToken cancellationToken)
        {
            ...
            if (match != null)
            {
                ...
                return await ProcessContainerRequestAsync(context, container, cancellationToken);
            }
        ...
        private async Task<HttpResponseMessage> ProcessContainerRequestAsync(HttpListenerContext context, ContainerName containerName, CancellationToken cancellationToken)
        {
            ValidateAuthenticatedRequest(context.Request);
            ...
            case "PUT":
                return await ProcessCreateContainerRequestAsync(context, containerName, cancellationToken);
        ...
        private async Task<HttpResponseMessage> ProcessCreateContainerRequestAsync(HttpListenerContext context, ContainerName containerName, CancellationToken cancellationToken)
        {
            ArchiveFormat archiveFormat = null;
