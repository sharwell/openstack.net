namespace Net.OpenStack.Testing.Integration.Providers.Rackspace
{
    ...
    public class UserQueuesTests
    {
        ...
        private class CalculatorOperation
        {
            ...
            [JsonProperty("reply")]
            public readonly string _replyQueueName;
            ...
            public CalculatorOperation(string replyQueueName, string command, long operand1, long operand2)
            {
                _id = Guid.NewGuid();
        ...
        private static IEnumerable<Task<IEnumerable<CloudQueue>>> ListAllQueuesAsync(IQueueingService provider, int? limit, bool detailed, CancellationToken cancellationToken)
        {
            ...
            do
            {
                string marker = lastQueue != null ? lastQueue.Name : null;
        ...
        private string CreateRandomQueueName()
        {
            return TestQueuePrefix + Path.GetRandomFileName().Replace('.', '_');
        }
