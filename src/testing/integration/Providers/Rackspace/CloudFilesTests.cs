...
namespace Net.OpenStack.Testing.Integration.Providers.Rackspace
{
    ...
    public class CloudFilesTests
    {
        ...
        {
            var provider = new CloudFilesProvider();
            provider.DeleteContainer(containerName, identity: _testIdentity);
        }
        ...
        {
            var provider = new CloudFilesProvider();
            provider.DeleteContainer(destinationContainerName, identity: _testIdentity);
        }
        ...
        public void Should_Copy_Object_When_Not_Passing_Content_Length_And_Passing_Expiring_Header()
        {
            ...
            var provider = new CloudFilesProvider(_testIdentity);
            provider.CopyObject(sourceContainerName, sourceObjectName, destinationContainerName, destinationObjectName, header);
