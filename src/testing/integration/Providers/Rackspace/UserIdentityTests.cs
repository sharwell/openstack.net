namespace Net.OpenStack.Testing.Integration.Providers.Rackspace
{
    ...
    public class UserIdentityTests
    {
        ...
        /// </summary>
        private static readonly string TestUserPrefix = "unitTestUser_";
        ...
        /// <summary>
        /// This method can be used to clean up users created by <see cref="IIdentityProvider.AddUser"/>
        ...
        public void CleanupUsers()
        {
            ...
            {
                if (Bootstrapper.Settings.TestIdentity.Username.Equals(user.Username))
                    continue;

                if (user.Username.StartsWith(TestUserPrefix))
                {
