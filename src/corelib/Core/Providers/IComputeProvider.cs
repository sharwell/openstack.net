...
namespace net.openstack.Core.Providers
{
    ...
    public interface IComputeProvider
    {
        ...
        /// <param name="personality">A collection of files to inject into the file system when the server is created.</param>
        ...
        /// <param name="diskConfig">The disk configuration. If the value is <c>null</c>, the default configuration for the specified image is used.</param>
        /// <param name="personality">A <see cref="Personality"/> object containing the details of a file to inject into the file system when the server is rebuilt.</param>
        /// <param name="region">The region in which to execute this action. If not specified, the user's default region will be used.</param>
        /// <param name="identity">The cloud identity to use for this request. If not specified, the default identity for the current provider instance will be used.</param>
        /// <returns>A <see cref="Server"/> object containing the details for the given server.</returns>
        /// <exception cref="ArgumentNullException">
