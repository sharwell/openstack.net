namespace net.openstack.Providers.Rackspace
{
    ...
    public class CloudAutoScaleProvider : ProviderBase<IAutoScaleService>, IAutoScaleService
    {
        ...
        /// <inheritdoc/>
        public Task<ScalingGroup> CreateGroupAsync(ScalingGroupConfiguration configuration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
        ...
        /// <inheritdoc/>
        public Task DeleteGroupAsync(ScalingGroupId groupId, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
        ...
        /// <inheritdoc/>
        public Task PauseGroupAsync(ScalingGroupId groupId, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
        ...
        /// <inheritdoc/>
        public Task ResumeGroupAsync(ScalingGroupId groupId, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
        ...
        /// <inheritdoc/>
        public Task SetGroupConfigurationAsync(ScalingGroupId groupId, GroupConfiguration configuration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
        ...
        /// <inheritdoc/>
        public Task SetLaunchConfigurationAsync(ScalingGroupId groupId, LaunchConfiguration configuration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
        ...
        /// <inheritdoc/>
        public Task<Policy> CreatePolicyAsync(ScalingGroupId groupId, PolicyConfiguration policyConfiguration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
            ...
            Func<Task<Tuple<IdentityToken, Uri>>, Task<HttpWebRequest>> prepareRequest =
                PrepareRequestAsyncFunc(HttpMethod.POST, template, parameters, new[] { policyConfiguration });
        ...
        /// <inheritdoc/>
        public Task SetPolicyAsync(ScalingGroupId groupId, PolicyId policyId, PolicyConfiguration policyConfiguration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
            if (policyId == null)
            ...
            Func<Task<Tuple<IdentityToken, Uri>>, Task<HttpWebRequest>> prepareRequest =
                PrepareRequestAsyncFunc(HttpMethod.PUT, template, parameters, policyConfiguration);
        ...
        /// <inheritdoc/>
        public Task DeletePolicyAsync(ScalingGroupId groupId, PolicyId policyId, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
            if (policyId == null)
        ...
        /// <inheritdoc/>
        public Task ExecutePolicyAsync(ScalingGroupId groupId, PolicyId policyId, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<ScalingGroup> progress)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
            if (policyId == null)
        ...
        /// <inheritdoc/>
        public Task<Webhook[]> CreateWebhookRangeAsync(ScalingGroupId groupId, PolicyId policyId, IEnumerable<NewWebhookConfiguration> configurations, CancellationToken cancellationToken)
        {
            if (groupId == null)
                throw new ArgumentNullException("groupId");
            if (policyId == null)
