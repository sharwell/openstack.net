namespace Rackspace.Security.Authentication
{
    ...
    /// <summary>
    /// This class provides utility methods for creating <see cref="AuthenticationRequest"/>
    /// instances suitable for authenticating with the Rackspace Cloud Identity service.
    /// </summary>
    ...
    {
        /// <summary>
        /// Create an <see cref="AuthenticationRequest"/> using the specified username
        /// and API key as credentials.
        /// </summary>
        ...
        /// which is typically used for constructing an instance of
        /// <see cref="RackspaceAuthenticationClient"/>.
        /// </returns>
        ...
        /// <remarks>
        /// <note type="warning">
        /// For improved security, clients are encouraged to use API key credentials instead of
        /// a password whenever possible.
        /// </note>
        /// </remarks>
        /// <param name="username">The account username.</param>
