namespace Rackspace.Services.Databases.V1
{
    ...
    public interface IDatabaseBackupExtension
    {
        ...
        /// </summary>
        /// <param name="configuration">A <see cref="BackupData"/> object containing the backup parameters.</param>
        ...
        Task<Backup> CreateBackupAsync(BackupData configuration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<DatabaseInstance> progress);
