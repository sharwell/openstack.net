...
#warning Need to define the exception(s) for cases where the requested service could not be found, and/or did not contain an endpoint in the specified region
        ...
        /// <item>This method attempts to filter the remaining items to those matching <paramref name="region"/>. If <paramref name="region"/> is <see langword="null"/>, the implementation defines the manner in which a default region (if any) is selected. If no services match the specified region, <em>this argument is ignored</em>.</item>
        /// <item>If the <paramref name="region"/> argument is ignored as a result of the previous rule, this method filters the remaining items to only include region-independent services, i.e. services offering a base address that is not associated with a particular named region.</item>
        /// </list>
        /// </remarks>
        /// <param name="serviceType">The service type to locate.</param>
        /// <param name="serviceName">The preferred name of the service.</param>
        /// <param name="region">The preferred region for the service. If this value is <see langword="null"/>, the implementation defines the manner in which a default region (if any) is selected.</param>
        ...
        /// <exception cref="NotSupportedException">The specified <paramref name="region"/> is not supported.</exception>
        ...
        /// </summary>
        /// <param name="requestMessage">The <see cref="HttpRequestMessage"/> describing the HTTP request to authenticate.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        /// <exception cref="ArgumentNullException">If <paramref name="requestMessage"/> is <see langword="null"/>.</exception>
        /// <exception cref="InvalidOperationException">If the specified HTTP request could not be authenticated.</exception>
