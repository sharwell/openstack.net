namespace OpenStack.Services.Networking.V2
{
    ...
    public class FixedIp : ExtensibleJsonObject
    {
        ...
        public FixedIp(SubnetId subnetId, IPAddress ipAddress, params JProperty[] extensionData)
            : base(extensionData)
        {
            _subnetId = subnetId;
            _ipAddress = ipAddress;
        ...
        public FixedIp(SubnetId subnetId, IPAddress ipAddress, IDictionary<string, JToken> extensionData)
            : base(extensionData)
        {
            _subnetId = subnetId;
            _ipAddress = ipAddress;
