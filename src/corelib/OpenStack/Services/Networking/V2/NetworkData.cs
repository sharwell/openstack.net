namespace OpenStack.Services.Networking.V2
{
    ...
    public class NetworkData : ExtensibleJsonObject
    {
        ...
        public NetworkData(string name, ProjectId projectId, bool? shared, bool? adminStateUp, params JProperty[] extensionData)
            : base(extensionData)
        {
            _name = name;
            _projectId = projectId;
        ...
        public NetworkData(string name, ProjectId projectId, bool? shared, bool? adminStateUp, IDictionary<string, JToken> extensionData)
            : base(extensionData)
        {
            _name = name;
            _projectId = projectId;
