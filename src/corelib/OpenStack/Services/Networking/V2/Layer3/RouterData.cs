namespace OpenStack.Services.Networking.V2.Layer3
{
    ...
    public class RouterData : ExtensibleJsonObject
    {
        ...
        public RouterData(string name, bool? adminStateUp, ExternalGateway externalGateway, params JProperty[] extensionData)
            : base(extensionData)
        {
            _name = name;
            _adminStateUp = adminStateUp;
        ...
        public RouterData(string name, bool? adminStateUp, ExternalGateway externalGateway, IDictionary<string, JToken> extensionData)
            : base(extensionData)
        {
            _name = name;
            _adminStateUp = adminStateUp;
