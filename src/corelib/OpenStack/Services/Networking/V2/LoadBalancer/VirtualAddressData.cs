namespace OpenStack.Services.Networking.V2.LoadBalancer
{
    ...
    public class VirtualAddressData : ExtensibleJsonObject
    {
        ...
        public VirtualAddressData(LoadBalancerProtocol protocol, int? port, string name, string description, SubnetId subnetId, IPAddress address, PoolId poolId, SessionPersistence sessionPersistence, int? connectionLimit, bool? adminStateUp, ProjectId projectId, params JProperty[] extensionData)
            : base(extensionData)
        {
            _protocol = protocol;
            _port = port;
        ...
        public VirtualAddressData(LoadBalancerProtocol protocol, int? port, string name, string description, SubnetId subnetId, IPAddress address, PoolId poolId, SessionPersistence sessionPersistence, int? connectionLimit, bool? adminStateUp, ProjectId projectId, IDictionary<string, JToken> extensionData)
            : base(extensionData)
        {
            _protocol = protocol;
            _port = port;
