namespace OpenStack.Services.Networking.V2.LoadBalancer
{
    ...
    public class MemberData : ExtensibleJsonObject
    {
        ...
        public MemberData(PoolId poolId, IPAddress address, LoadBalancerProtocol protocol, int? port, int? weight, bool? adminStateUp, ProjectId projectId, params JProperty[] extensionData)
            : base(extensionData)
        {
            _poolId = poolId;
            _address = address;
        ...
        public MemberData(PoolId poolId, IPAddress address, LoadBalancerProtocol protocol, int? port, int? weight, bool? adminStateUp, ProjectId projectId, IDictionary<string, JToken> extensionData)
            : base(extensionData)
        {
            _poolId = poolId;
            _address = address;
