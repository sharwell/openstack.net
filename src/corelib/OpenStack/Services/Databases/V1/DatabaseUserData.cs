namespace OpenStack.Services.Databases.V1
{
    ...
    public class DatabaseUserData : ExtensibleJsonObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DatabaseUserData"/> class
        /// during JSON deserialization.
        /// </summary>
        [JsonConstructor]
        protected DatabaseUserData()
        {
        }
        ...
        /// </exception>
        public DatabaseUserData(UserName name, string password, IEnumerable<DatabaseName> databases)
        ...
        /// <para>If <paramref name="databases"/> contains any <see langword="null"/> values.</para>
        /// </exception>
        public DatabaseUserData(UserName name, string password, params DatabaseName[] databases)
        {
            if (name == null)
