...
namespace OpenStack.Services.Databases.V1
{
    ...
    public interface IDatabaseService : IHttpService
    {
        ...
        ///// </summary>
        ///// <param name="configuration">A <see cref="DatabaseInstanceData"/> object describing the configuration of the new database instance.</param>
        ...
        //Task<DatabaseInstance> CreateDatabaseInstanceAsync(DatabaseInstanceData configuration, AsyncCompletionOption completionOption, CancellationToken cancellationToken, IProgress<DatabaseInstance> progress);
        Task<CreateDatabaseInstanceApiCall> PrepareCreateDatabaseInstanceAsync(DatabaseInstanceRequest request, CancellationToken cancellationToken);
        ...
        Task<ListDatabaseInstancesApiCall> PrepareListDatabaseInstancesAsync(CancellationToken cancellationToken);
        ...
        Task<GetDatabaseInstanceApiCall> PrepareGetDatabaseInstanceAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);
        ...
        Task<RemoveDatabaseInstanceApiCall> PrepareRemoveDatabaseInstanceAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);
        ...
        //Task<DatabaseUser> EnableRootUserAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);
        Task<EnableRootUserApiCall> PrepareEnableRootUserAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);
        ...
        Task<CheckRootEnabledApiCall> PrepareCheckRootEnabledAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);
        ...
        Task<RestartDatabaseInstanceApiCall> PrepareRestartDatabaseInstanceAsync(DatabaseInstanceId instanceId, RestartRequest request, CancellationToken cancellationToken);
        ...
        Task<ResizeDatabaseInstanceApiCall> PrepareResizeDatabaseInstanceAsync(DatabaseInstanceId instanceId, ResizeRequest request, CancellationToken cancellationToken);
        ...
        Task<ResizeDatabaseInstanceVolumeApiCall> PrepareResizeDatabaseInstanceVolumeAsync(DatabaseInstanceId instanceId, ResizeVolumeRequest request, CancellationToken cancellationToken);
        ...
        ///// </summary>
        ///// <param name="instanceId">The database instance ID. This is obtained from <see cref="DatabaseInstance.Id">DatabaseInstance.Id</see>.</param>
        ///// <param name="configuration">A <see cref="DatabaseData"/> object describing the configuration of the new database.</param>
        ///// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        ...
        //Task CreateDatabaseAsync(DatabaseInstanceId instanceId, DatabaseData configuration, CancellationToken cancellationToken);
        Task<CreateDatabasesApiCall> PrepareCreateDatabasesAsync(DatabaseInstanceId instanceId, DatabasesRequest request, CancellationToken cancellationToken);
        ...
        Task<ListDatabasesApiCall> PrepareListDatabasesAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);
        ...
        Task<RemoveDatabaseApiCall> PrepareRemoveDatabaseAsync(DatabaseInstanceId instanceId, DatabaseName databaseName, CancellationToken cancellationToken);
        ...
        ///// </summary>
        ///// <param name="instanceId">The database instance ID. This is obtained from <see cref="DatabaseInstance.Id">DatabaseInstance.Id</see>.</param>
        ///// <param name="configuration">A <see cref="DatabaseUserData"/> object describing the configuration of the new user.</param>
        ///// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        ///// <returns>A <see cref="Task"/> object representing the asynchronous operation.</returns>
        ///// <exception cref="ArgumentNullException">
        ///// If <paramref name="instanceId"/> is <see langword="null"/>.
        ...
        //Task CreateUserAsync(DatabaseInstanceId instanceId, DatabaseUserData configuration, CancellationToken cancellationToken);
        Task<CreateUsersApiCall> PrepareCreateUsersAsync(DatabaseInstanceId instanceId, UsersRequest request, CancellationToken cancellationToken);
        ...
        Task<ListUsersApiCall> PrepareListUsersAsync(DatabaseInstanceId instanceId, CancellationToken cancellationToken);

        ///// <summary>
        ///// Set the password for a database user.
        ///// </summary>
        ///// <param name="instanceId">The database instance ID. This is obtained from <see cref="DatabaseInstance.Id">DatabaseInstance.Id</see>.</param>
        ///// <param name="userName">A <see cref="UserName"/> object identifying the database user. This is obtained from <see cref="DatabaseUserData.UserName">UserConfiguration.UserName</see>.</param>
        ...
        //Task UpdateUserAsync(DatabaseInstanceId instanceId, UserName userName, DatabaseUserData configuration, CancellationToken cancellationToken);
        ...
        Task<RemoveUserApiCall> PrepareRemoveUserAsync(DatabaseInstanceId instanceId, UserName userName, CancellationToken cancellationToken);
