namespace OpenStack.Services.ObjectStorage.V1
{
    ...
    /// <summary>
    /// Represents a provider for asynchronous operations on the OpenStack Object Storage Service.
    /// </summary>
    ...
    public interface IObjectStorageService : IHttpService
    {
        ...
        /// <summary>
        /// Prepare an API call to determine the features enabled in the Object Storage service.
        /// </summary>
        ...
        /// <summary>
        /// Prepare an API call to get the metadata associated with the authenticated account in the Object Storage service.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        /// <returns>
        /// A <see cref="Task"/> representing the asynchronous operation. When the task
        ...
        /// <summary>
        /// Prepare an API call to update the metadata associated with the authenticated account in the Object Storage service.
        /// </summary>
        /// <remarks>
        /// This API call sets the value of metadata items which are already associated with the account,
        /// and adds the items which are not already present. If an element in <paramref name="metadata"/>
        /// has an empty value, the metadata item with the corresponding key is removed. Account metadata
        /// items which do not match any of the keys in <paramref name="metadata"/> are left unchanged.
        /// </remarks>
        ...
        /// <summary>
        /// Prepare an API call to remove particular metadata associated with the authenticated account
        ...
        /// <exception cref="ArgumentException">If <paramref name="keys"/> contains any <seealso langword="null"/> or empty values.</exception>
        /// <exception cref="HttpWebException">If an HTTP API call failed during the preparation of this API call.</exception>
        /// <seealso cref="UpdateAccountMetadataApiCall"/>
        ...
        /// </summary>
        /// <remarks>
        /// This API call sets the value of metadata items which are already associated with the container,
        /// and adds the items which are not already present. If an element in <paramref name="metadata"/>
        /// has an empty value, the metadata item with the corresponding key is removed. Container metadata
        /// items which do not match any of the keys in <paramref name="metadata"/> are left unchanged.
        /// </remarks>
        ...
        /// <summary>
        /// Prepare an API call to remove particular metadata associated with a container
        /// in the Object Storage service.
        /// </summary>
        /// <param name="container">The name of the container to update.</param>
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        /// <param name="progress">
        /// An <see cref="IProgress{T}"/> instance receiving progress updates during the request.
        /// <para>-or-</para>
        ...
        /// <note type="warning">
        /// This method does not behave like other metadata methods in the Object Storage service; the
        /// metadata associated with an object is updated all at once, including the values in both the
        /// <see cref="StorageMetadata.Headers"/> and <see cref="StorageMetadata.Metadata"/> collections.
        /// </note>
        /// </summary>
        /// <param name="container">The container name.</param>
        /// <param name="object">The object name.</param>
        /// <param name="metadata">The complete metadata to associate with the object, replacing all previous metadata.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        /// <returns>
        /// A <see cref="Task"/> representing the asynchronous operation. When the task
        /// completes successfully, the <see cref="Task{TResult}.Result"/> property returns
