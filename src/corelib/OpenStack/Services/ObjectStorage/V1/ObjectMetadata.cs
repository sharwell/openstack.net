namespace OpenStack.Services.ObjectStorage.V1
{
    ...
    /// <summary>
    /// This class extends <see cref="StorageMetadata"/> to represent metadata
    /// associated with an object in the Object Storage service.
    /// </summary>
    ...
    public class ObjectMetadata : StorageMetadata
    {
        ...
        /// </summary>
        private static readonly ObjectMetadata _emptyMetadata = new ObjectMetadata(new Dictionary<string, string>(), new Dictionary<string, string>());

        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectMetadata"/> class
        /// using the metadata present in the specified response message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectMetadata"/> class
        /// with the specified HTTP headers and custom object metadata.
        /// </summary>
